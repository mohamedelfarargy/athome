                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="top-left d-flex">
                            ...
                            <div class="call-us">
                                <p><img src="images/phn.png" alt="">+20 (15)51669241</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="top-right text-right">
                            <ul class="list-unstyled list-inline">
                                ...
                                <?php }else{
                                    ...
                                    ?>
                                        <li class="list-inline-item"><a href="08-login.php"><img src="images/login.png" alt="">logout</a></li>
                                    <?php }?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="r-customer">
                            ...
                            <form action="admin/function/login_v.php" method="post">
                                <div class="emal">
                            ...
                            <br>
                            <div style="width:300px;font-weight:bold;" class="<?php if(isset($_GET['alert'])){echo"alert alert-danger";} ?>">
                            <?php
                                if(isset($_GET['alert'])){
                                echo $_GET['alert'];
                                }
